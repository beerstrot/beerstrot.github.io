function showNotes(e){$(".form").hide(),$("#infoDiv").hide(),$(".clearme").remove();$("#notesDiv").show();$("#innerNotesDiv").show(),$.ajax({url:"http://localhost:5001/bookings",type:"GET",data:{date:e||"2022-06-13T09:40:41.729Z"},crossDomain:!0,error:e=>{$("#loading").hide(),showMessage(`Si prega di riprovare perché abbiamo riscontrato un errore.
        ...
        La ID della prenotazione è: ${o}.`)},beforeSend:function(){$("#loading").show()},success:e=>{$("#loading").hide(),console.log(e,"SUCCESS"),window.bbb=e.booking,presentReservation(e.booking)}})}function presentReservation(t){if(!t||"error"in t)return bookingNotFound();var e=t.booking_customer,o=JSON.parse(t.notes);const a=new Date(t.booked_for),n=new Date(a.getTime()+6e4*t.duration);var i=$("#innerInfoDiv");const s=$("<fieldset/>").appendTo(i);$("<legend/>").text("Informazione della Prenotazione").appendTo(s);var i=(e,o)=>$("<div/>",{id:"i_"+o}).html(`<b>${e}</b>: `+t[o]).appendTo(s),r=(e,o)=>$("<div/>").html(`<b>${e}</b>: `+o).appendTo(s);r("Nome",e.first_name+" "+e.last_name),r("Telefono",o.telephone||"--"),r("Email",o.email||"--"),$("<br/>").appendTo(s),r("Quando",a.toLocaleString("it-IT",{weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})+"-"+n.toLocaleString("it-IT",{hour:"2-digit",minute:"2-digit"})),i("Quantità di ospiti","people"),r("Osservazioni",o.note),r("Cani",o.cani?"sì":"no"),r("Seggiolini",o.seggiolini?"sì":"no"),$("<br/>").appendTo(s),i("Status","status"),i("ID della prenotazione","id"),$("#modBtn").click(()=>{console.log("mod")}).hide();const l=t.id;$("#cancBtn").click(()=>{console.log("can"),$.ajax({url:"http://localhost:5001/cancel",type:"GET",crossDomain:!0,data:{pid:l},dataType:"json",contentType:"application/json; charset=utf-8",error:e=>{$("#loading").hide(),showMessage(`Si prega di riprovare perché abbiamo riscontrato un errore.
          Se il problema persiste, consigliamo di 
          <a href="https://www.messenger.com/t/397632563730269/" target="_blank">entrare in chat</a>
          per consultare sulla prenotazione.<br>
